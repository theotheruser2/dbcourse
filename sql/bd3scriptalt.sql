...
SELLER_ID INTEGER NOT NULL REFERENCES MAGE(MAGE_ID) ON UPDATE CASCADE ON DELETE CASCADE,
BUYER_ID INTEGER NOT NULL REFERENCES MAGE(MAGE_ID) ON UPDATE CASCADE ON DELETE CASCADE,
TRADE_ID INTEGER NOT NULL REFERENCES TRADE(TRADE_ID) ON UPDATE CASCADE ON DELETE CASCADE
);
